...
Opening a pull request will trigger a[workflow](../.github/workflows/dabs_project-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-1221088626525134.14.azuredatabricks.net/ml/models/staging-dabs_project-model)
* [Prod workspace registered model](https://adb-2182082488917974.14.azuredatabricks.net/ml/models/prod-dabs_project-model). 
