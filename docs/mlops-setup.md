...
git add README.md docs .gitignore dabs_project/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-1221088626525134.14.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-2182082488917974.14.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[dabs_project/databricks.yml](../dabs_project/databricks.yml) file.
...
Follow the instructions in [dabs_project/resources/README.md](../dabs_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../dabs_project/resources/README.md)  to propose, test, and deploy
